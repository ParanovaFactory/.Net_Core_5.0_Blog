        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperienceImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TestmonialId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TestmonialName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TestmonialCompany = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TestmonialComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TestmonialImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
